...
try:
    ...
    print("We cannot automagically determine source file encoding. Please install charset_normalizer via pip")
    _NORMALIZER=False
...
def parse_csv(csv_filename: str, csv_delimiter: str, encoding: str = None) -> dict:
    ...
    try:
        ...
        print(f"Failed to decode file with encoding {encoding}. Try to adjust manually with --encoding parameter")
        return []
